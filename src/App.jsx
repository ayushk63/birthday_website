    ...
    <>
      <div id = 'App'>
        ...
        <div id = 'div1'>
          ...
          <img id = 'rapunzel2' src='src/rapunzel2.jpg' />
          <div id = 'right'>
          </div>
        </div>
        ...
        <div id = 'sketches'>
          <div id = 'sketchRow1'>
            <img className='sketch' src = 'src/sketch1.jpg' />
            <img className='sketch' src = 'src/sketch2.jpg' />
            <img className='sketch' src = 'src/sketch3.jpg' />
          </div>
          <div id = 'sketchRow2'>
            <img className='sketch' src = 'src/sketch4.jpg' />
            <img className='sketch' src = 'src/sketch5.jpg' />
          </div>
        </div>
        <div id = 'greetingsTitle'>GREETINGS</div>
        <img id = 'rapunzel1' src = 'src/rapunzel1.jpg' />
        <div id = 'greetings'>
